  ...
  run: async () => {
    ...
    frappe.ui.form.on(cur_frm.doctype, {
      async before_workflow_action(form: FrappeForm) {
        ...
        // if (ws === STATUS.WORKFLOW.REVISION && action === ACTION.APPROVE_CORRECTION) {
      ...
      async onload(form: FrappeForm) {
        ...
        msg += form.doc.workflow_state === STATUS.WORKFLOW.REVISION
          ...
          : `<p>${__("There are pending requests. You can send for review by clicking")} '${ACTION.REVIEW}'.</p>`;
