...
(() => {
  ...
  // public/ts/checklist/checklists.ts
  ...
  // public/ts/corrections_tracker/run.ts
  ...
  // public/ts/ui/enhanced_dialog.ts
  ...
  // public/ts/utils/brazil/cnpj.ts
  ...
  // public/ts/utils/brazil/cpf_cnpj.ts
  ...
  // public/ts/utils/brazil/phone.ts
  frappe.provide("agt.utils.brazil");
  ...
  // public/ts/workflow/validate.ts
  ...
  agt.workflow.validate = async (action_extended) => {
    ...
    for (const wv of validations_to_run) {
      ...
      const missing_fields_name = req_fields.filter((f) => {
        ...
        if (not_missing(value)) return false;
        if (f.should_validate && !f.should_validate(cur_frm)) return false;
        return true;
      }).map((f) => f.name);
  ...
  // public/ts/workflow/pre_action.ts
  ...
  // public/ts/metadata/doctype/ticket.ts
