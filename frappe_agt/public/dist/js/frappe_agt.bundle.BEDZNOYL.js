...
(() => {
  ...
  // ../frappe_agt/frappe_agt/public/js/utils/db/index.js
  ...
  agt.utils.doc.create_doc = async function(doctype, fields_target, fields_dict) {
    ...
    for (const targetField of fields_target) {
      if (!valid_fields.includes(targetField))
        continue;
      let value;
      if (targetField === "docname" && (cur_frm == null ? void 0 : cur_frm.docname)) {
        value = cur_frm.docname;
      } else if ((cur_frm == null ? void 0 : cur_frm.doc) && targetField in cur_frm.doc) {
...
//# sourceMappingURL=frappe_agt.bundle.BEDZNOYL.js.map
